        ...
        <div class="contenu-footer">
            ...
            <div class="colonne-footer">
                ...
                <ul style="list-style: none; padding: 0;">
                    <li style="margin-bottom: var(--espacement-xs);"><a href="/grass_farmers/pages/service.php#fabrication">Fabrication
                            sur mesure</a></li>
                    <li style="margin-bottom: var(--espacement-xs);"><a href="/grass_farmers/pages/service.php#pose">Pose et
                            installation</a></li>
                    <li style="margin-bottom: var(--espacement-xs);"><a
                            href="/grass_farmers/pages/service.php#renovation">Rénovation</a></li>
                    <li style="margin-bottom: var(--espacement-xs);"><a
                            href="/grass_farmers/pages/service.php#amenagement">Aménagement</a></li>
                </ul>
            </div>
