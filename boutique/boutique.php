    ...
    <header class="en-tete" id="en-tete">
        <div class="conteneur">
            <div class="header-contenu">
                <a href="index.html" class="logo"><img src="../page_acceuil/assets/ayoubdecor_logoo.png" alt="ayoub_logo"></a>
                ...
                <div class="header-actions">
                    <a href="./js/login.php" class="btn btn-secondaire" style="padding: 10px 15px;">Admin</a>
                    <a href="devis.html" class="btn btn-primaire" class="btn btn-secondaire" style="padding: 15px 20px;">Demander un devis</a>
            ...
            <div class="grille-produits" id="grille-produits">
                ...
                <?php else: ?>
                    ...
                    <div class="produit" data-categorie="<?php echo htmlspecialchars($product['categorie']); ?>" data-stock="<?php echo $product['stock']; ?>">
                        <img src="<?php echo htmlspecialchars(str_replace('./assets/', 'assets/', $product['image'])); ?>" alt="<?php echo htmlspecialchars($product['nom']); ?>" class="produit-image" loading="lazy">
        ...
        <aside class="card" style="padding:16px; margin-top:16px" aria-labelledby="panier-title">
            ...
            <?php else: ?>
                ...
                <div style="margin-top: 15px;">
                    <a href="https://wa.link/uwg5zr" target="_blank"><button class="btn btn-primaire" style="width: 100%; padding: var(--espacement-sm) var(--espacement-lg);">Procéder au paiement</button></a> 
                </div>
            <?php endif; ?>
        </aside>
    </section>
        ...
        <div class="conteneur">
            <div class="section-header" style="text-align: center;">
                ...
                <div style="margin-top: var(--espacement-xl);">
                    <a href="devis.html" class="btn btn-primaire" style="margin-right: var(--espacement-md); padding: var(--espacement-sm) var(--espacement-lg);">Demander un devis</a>
                    <a href="services.html" class="btn btn-secondaire" style="border-color: var(--neutral-100); color: var(--neutral-100); padding: var(--espacement-sm) var(--espacement-lg);">Nos services</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="contenu-footer">
                ...
                <div class="colonne-footer">
                    ...
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: var(--espacement-xs);"><a href="services.html#fabrication">Fabrication sur mesure</a></li>
                        <li style="margin-bottom: var(--espacement-xs);"><a href="services.html#pose">Pose et installation</a></li>
                        <li style="margin-bottom: var(--espacement-xs);"><a href="services.html#renovation">Rénovation</a></li>
                        <li style="margin-bottom: var(--espacement-xs);"><a href="services.html#amenagement">Aménagement</a></li>
                    </ul>
                </div>
