        ...
        <div class="conteneur">
            <div class="section-header" style="text-align: center;">
                ...
                <div style="margin-top: var(--espacement-xl);">
                    <a href="/grass_farmers/page_devis/devis.php" class="btn btn-primaire" style="margin-right: var(--espacement-md);">Demander
                        un devis</a>
                    <a href="/grass_farmers/page_acceuil/contact.php" class="btn btn-secondaire"
        ...
        <div class="contenu-footer">
            ...
            <div class="colonne-footer">
                ...
                <ul style="list-style: none; padding: 0;">
                    <li style="margin-bottom: var(--espacement-xs);"><a href="/grass_farmers/page_acceuil/services.php#fabrication">Fabrication
                            sur mesure</a></li>
                    <li style="margin-bottom: var(--espacement-xs);"><a href="/grass_farmers/page_acceuil/services.php#pose">Pose et
                            installation</a></li>
                    <li style="margin-bottom: var(--espacement-xs);"><a
                            href="/grass_farmers/page_acceuil/services.php#renovation">Rénovation</a></li>
                    <li style="margin-bottom: var(--espacement-xs);"><a
                            href="/grass_farmers/page_acceuil/services.php#amenagement">Aménagement</a></li>
                </ul>
            </div>
