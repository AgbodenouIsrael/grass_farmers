    ...
    <header class="en-tete">
        <div class="conteneur">
            <div class="header-contenu">
                <a href="../pages/boutique.php" class="logo">AYOUBDECOR</a>
                <nav class="menu-principal">
                    <ul>
                        <li><a href="../pages/boutique.php">Retour à la boutique</a></li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="conteneur">
            <div class="login-container">
                <div class="login-card">
                    ...
                    <form id="login-form" class="login-form" method="POST" action="../src/controllers/traitementLogin.php">
